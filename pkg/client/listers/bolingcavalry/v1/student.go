...
type StudentLister interface {
	...
	GetByKey(key string) (*v1.Student, error)
...
func (s *studentLister) GetByKey(key string) (*v1.Student, error) {
...
func (s studentNamespaceLister) Get(name string) (*v1.Student, error) {
	...
	if !exists {
		return nil, errors.NewNotFound(corev1.Resource("student"), name)
	}
